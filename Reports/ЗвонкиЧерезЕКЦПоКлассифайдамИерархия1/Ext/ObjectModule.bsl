...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПрочитатьИерархию("Отчет_ВходящиеЗвонкиПоКлассифайдам_Иерархия");
	...
	|	1 КАК Количество,
	|	ЗвонкиСтатОбщая.ОПСсылка КАК ОПСсылка
	...
	|	ВТ010_БезИерархии.ОПСсылка КАК ОПСсылка,
