...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отчет.ИерархияИмя = "Отчет_ВходящиеЗвонкиПоКлассифайдам_Иерархия";
...
Процедура ОткрытьИерархию(Команда) 
	...
	ОткрытьФорму("Отчет.ЗвонкиЧерезЕКЦПоКлассифайдамИерархия1.Форма.Иерархия", Парам, ЭтаФорма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);	
КонецПроцедуры
