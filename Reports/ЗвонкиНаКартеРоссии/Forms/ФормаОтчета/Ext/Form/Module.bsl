...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//--------------------------------
	Элементы.ВыбранныйВариантОтчета.СписокВыбора.Добавить("а", 	"Звонков всего на контакт центр");
	Элементы.ВыбранныйВариантОтчета.СписокВыбора.Добавить("б", 	"Звонков целевых на контакт центр");
...
Процедура РезультатВыбор(Элемент, Область, СтандартнаяОбработка)
	//Парам = Новый Структура("Регион", Область.Расшифровка);
	//ОткрытьФорму("ВнешнийОтчет.ДоступностьСТО.Форма.ФормаРасшифровки",,ЭтаФорма,,,,,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
КонецПроцедуры
