...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)    
	...
	ЭтаФорма.Отчет.НеУчитыватьИсключаемыеСферыВРасчетеКоличестваНегативныхОтзывов = Истина;
	
	Элементы.Вариант.СписокВыбора.Добавить("Сводный",			"Сводный общий (без Владимира)");
	Элементы.Вариант.СписокВыбора.Добавить("СводныйГАЗ",		"Сводный ГАЗ (без Владимира)");
	Элементы.Вариант.СписокВыбора.Добавить("СводныйВладимир",	"Сводный только Владимир");
	Элементы.Вариант.СписокВыбора.Добавить("СводныйКАМАЗ",		"Сводный КАМАЗ (без Владимира)");
	Элементы.Вариант.СписокВыбора.Добавить("СводныйУАЗ",		"Сводный УАЗ (без Владимира)");
	Элементы.Вариант.СписокВыбора.Добавить("СводныйChery",		"Сводный Chery (без Владимира)");
	Элементы.Вариант.СписокВыбора.Добавить("СводныйFord",		"Сводный Ford (без Владимира)");
	...
	//---------------------------------------------------------------------------------------------
	Вар = "";
	Доступно = 		Параметры.Свойство("ТекВариант", Вар)
...
Процедура ВариантОбработкаВыбораНаСервере(ИмяВарианта)
	...
	Если ИмяВарианта = "СводныйГАЗ" Или ИмяВарианта = "СводныйКАМАЗ" Или ИмяВарианта = "СводныйУАЗ" Или ИмяВарианта = "СводныйChery" Или ИмяВарианта = "СводныйFord" Или  ИмяВарианта = "СводныйВладимир" Тогда
