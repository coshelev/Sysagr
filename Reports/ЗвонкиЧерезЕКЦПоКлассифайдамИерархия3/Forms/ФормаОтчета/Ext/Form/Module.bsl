...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отчет.ИерархияИмя = "Отчет_ВходящиеЗвонкиПоКлассифайдам_Иерархия3";
...
Процедура ОткрытьИерархию(Команда) 
	...
	ОткрытьФорму("Отчет.ЗвонкиЧерезЕКЦПоКлассифайдамИерархия3.Форма.Иерархия", Парам, ЭтаФорма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);	
КонецПроцедуры
