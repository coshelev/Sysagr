...
Функция Сформировать() Экспорт
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	НАЧАЛОПЕРИОДА(Задачи.Дата, ДЕНЬ) КАК Дата,
	|	Задачи.Инициатор КАК Инициатор,
	...
	|СГРУППИРОВАТЬ ПО
	|	Задачи.Инициатор,
	|	НАЧАЛОПЕРИОДА(Задачи.Дата, ДЕНЬ),
	...
	|	НАЧАЛОПЕРИОДА(Рег.ПериодЗаявки, ДЕНЬ) КАК Период,
	|	СУММА(ВЫБОР
	|			КОГДА Рег.Сервис.Наименование = ""Google AdWords""
	...
	|		ИНАЧЕ ""<источник заявки не определен>""
	|	КОНЕЦ,
	|	НАЧАЛОПЕРИОДА(Рег.ПериодЗаявки, ДЕНЬ)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТ010.ДатаТек КАК ДатаТек,
	|	ВТ010.Инициатор КАК Инициатор,
	|	ВТ010.ИсточникЗаявки КАК ИсточникЗаявки,
	|	ВТ010.Количество КАК Количество,
	|	ВТ010.КоличествоЦелевых КАК КоличествоЦелевых,
	|	ВТ010.Группа КАК Группа,
	|	ВТ010.СтоимостьКомпанийСайта КАК СтоимостьКомпанийСайта,
	|	ВТ010.СтоимостьЗаявки КАК СтоимостьЗаявки
	|ИЗ
	|	ВТ010 КАК ВТ010" ;
