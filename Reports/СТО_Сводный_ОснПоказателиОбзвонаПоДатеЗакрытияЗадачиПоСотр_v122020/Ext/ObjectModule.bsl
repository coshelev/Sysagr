...
Функция Сводный()
	...
	|			И (ВТ03.КоличествоНеДоволенНеРекомендует = 1
	|				ИЛИ ВТ03.КоличествоНедоволенРекомендует = 1
	|				ИЛИ ВТ03.КоличествоДоволенНерекомендует = 1)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	МИНИМУМ(ВТ05.ПорядокПараметра) КАК ПорядокПараметра,
	|	СУММА(ВЫБОР
	...
	|	СУММА(ВТ05.ЗначениеДопПараметра) КАК ЗначениеДопПараметра,
	|	СУММА(ВЫБОР
	|			КОГДА ВТ05.ИмяГруппы = ""Доля негативных отзывов""
	|				ТОГДА ВЫБОР
