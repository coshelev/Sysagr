...
Процедура ОбновитьФормуНаСервере()
	...
	Отчет.ВыбранныйВариантОтчета = "СводныйКаналыСайты";
	Элементы.ВыбранныйВариантОтчета.СписокВыбора.Очистить();
	Элементы.ВыбранныйВариантОтчета.СписокВыбора.Добавить("СводныйКаналыСайты", 		"Все каналы/сайты по целевым точкам");
	Элементы.ВыбранныйВариантОтчета.СписокВыбора.Добавить("СводныйКаналыСайтыДинамика", "Все каналы/сайты по целевым точкам, динамика");
