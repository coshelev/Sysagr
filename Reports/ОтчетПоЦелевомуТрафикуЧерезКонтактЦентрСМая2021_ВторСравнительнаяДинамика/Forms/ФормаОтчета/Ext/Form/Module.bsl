...
Процедура ОбновитьФормуНаСервере()
	...
	Отчет.ВыбранныйВариантОтчета="Динамика1";
	...
	//Элементы.ВыбранныйВариантОтчета.СписокВыбора.Добавить("Динамика",				"Динамика");
	//Элементы.ВыбранныйВариантОтчета.СписокВыбора.Добавить("ДинамикаСредние",		"Динамика + средние");  
	//Элементы.ВыбранныйВариантОтчета.СписокВыбора.Добавить("ДинамикаПоМесяцам",	"Динамика звонков по месяцам");  
	Элементы.ВыбранныйВариантОтчета.СписокВыбора.Добавить("Динамика1",				"Сравнительная динамика целевых звонков за 3 периода");  
