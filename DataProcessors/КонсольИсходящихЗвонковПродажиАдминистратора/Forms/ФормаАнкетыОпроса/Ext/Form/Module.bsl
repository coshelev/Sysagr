...
Функция СтартуйБП(СигнатураПродажи, Дата, ДатаСтарта, ТочкаПродажи, Телефон, ПодразделениеИсполнитель, ПодразделениеКонтролер = Неопределено, ДопРеквизитАдресации = "")
	...
	//-----------------------------------------------------
	Запрос = Новый Запрос("ВЫБРАТЬ ПЕРВЫЕ 1 Ссылка ИЗ БизнесПроцесс.ОбратнаяСвязьЛояльностиПродаж ГДЕ Стартован И НЕ Завершен И СигнатураПродажи = &СигнатураПродажи");
