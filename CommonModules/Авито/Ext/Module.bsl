...
Функция ЗаписатьЗначениеJSON(Об) Экспорт 	
...
Функция ПрочитатьЗначениеXML(Стр) Экспорт          
	//Аналог javascript JSON.parse() - возврат объекта из json-строки
	//----------------------------------------------------------------
...
Функция ПрочитатьЗначениеJsonВСоответствие(Стр) Экспорт          
	//Аналог javascript JSON.parse() - возврат объекта из json-строки
	//----------------------------------------------------------------
